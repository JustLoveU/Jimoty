	...
	<view class="uni-container">
		<uni-forms ref="form" :model="formData" validateTrigger="bind">
			<uni-forms-item name="userId" label="发布者" required>
				<uni-easyinput placeholder="发布者" v-model="formData.userId"></uni-easyinput>
			</uni-forms-item>
			...
			<uni-forms-item name="photos" label="图片">
				<uni-data-checkbox :multiple="true" v-model="formData.photos"></uni-data-checkbox>
			</uni-forms-item>
			<uni-forms-item name="point" label="地理位置">
				<uni-data-checkbox :multiple="true" v-model="formData.point"></uni-data-checkbox>
			</uni-forms-item>
			...
			<uni-forms-item name="location" label="地理位置">
				<uni-easyinput v-model="formData.location"></uni-easyinput>
			</uni-forms-item>
