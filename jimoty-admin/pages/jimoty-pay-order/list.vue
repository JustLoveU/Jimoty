<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="user_id,total_fee,custom,order_no,type,status,create_date,pay_date" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'custom')">自定义数据</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">{{item.custom}}</uni-td>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/jimoty-pay-order.js';
