...
const uniIdCo = common_vendor.Vs.importObject("uni-id-co", { customUI: true });
const _sfc_main = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("agreements", "3f6ae73a-9,3f6ae73a-0"),
    v: common_vendor.p({
      scope: "register"
    }),
    ...
    z: common_vendor.sr("form", "3f6ae73a-0"),
    A: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
