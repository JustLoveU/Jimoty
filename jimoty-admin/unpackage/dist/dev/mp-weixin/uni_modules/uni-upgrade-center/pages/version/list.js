...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.w(({
      ...
      return {
        a: "1d78f970-4-" + i0 + "," + ("1d78f970-3-" + i0),
        b: "1d78f970-5-" + i0 + "," + ("1d78f970-3-" + i0),
        c: "1d78f970-6-" + i0 + "," + ("1d78f970-3-" + i0),
        d: "1d78f970-7-" + i0 + "," + ("1d78f970-3-" + i0),
        e: "1d78f970-8-" + i0 + "," + ("1d78f970-3-" + i0),
        f: "1d78f970-9-" + i0 + "," + ("1d78f970-3-" + i0),
        g: "1d78f970-10-" + i0 + "," + ("1d78f970-3-" + i0),
        h: "1d78f970-11-" + i0 + "," + ("1d78f970-3-" + i0),
        i: "1d78f970-12-" + i0 + "," + ("1d78f970-3-" + i0),
        j: "1d78f970-3-" + i0 + "," + ("1d78f970-2-" + i0),
        k: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "1d78f970-14-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            c: common_vendor.t(item.title || "-"),
            d: "1d78f970-15-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            ...
            i: "1d78f970-16-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            j: "1d78f970-18-" + i0 + "-" + i1 + "," + ("1d78f970-17-" + i0 + "-" + i1),
            k: common_vendor.p({
            ...
            l: "1d78f970-17-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            m: common_vendor.t($options.store_list_key(item.store_list)),
            n: "1d78f970-19-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            o: common_vendor.t(item.version),
            p: "1d78f970-20-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            q: common_vendor.t(item.stable_publish == true ? "已上线" : "已下线"),
            r: "1d78f970-21-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            s: "1d78f970-23-" + i0 + "-" + i1 + "," + ("1d78f970-22-" + i0 + "-" + i1),
            t: common_vendor.p({
              format: "yyyy-MM-dd hh:mm:ss",
              date: item.create_date,
              threshold: [0, 0]
            }),
            v: "1d78f970-22-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            w: common_vendor.o(($event) => $options.navigateTo("./detail?id=" + item._id, false), index),
            x: "1d78f970-24-" + i0 + "-" + i1 + "," + ("1d78f970-13-" + i0 + "-" + i1),
            y: index,
            z: "1d78f970-13-" + i0 + "-" + i1 + "," + ("1d78f970-2-" + i0),
            A: common_vendor.p({
              disabled: item.stable_publish
            })
          };
        }),
        l: "1d78f970-2-" + i0 + ",1d78f970-1",
        m: common_vendor.p({
          loading,
    ...
    J: common_vendor.sr("udb", "1d78f970-1"),
    K: common_vendor.p({
