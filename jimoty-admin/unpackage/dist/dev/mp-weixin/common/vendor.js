...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__EFAF570",
    appName: "jimoty-admin",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/jimoty-post/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-post/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-post/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-category/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-category/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-category/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-chat-message/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-chat-message/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-chat-message/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-chat/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-chat/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-chat/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-comment/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-comment/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-comment/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-daoju/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-daoju/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-daoju/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-daoju-use/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-daoju-use/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-daoju-use/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-sec-check-img-log/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-sec-check-img-log/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-sec-check-img-log/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-pay-order/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-pay-order/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-pay-order/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/jimoty-notice/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/jimoty-notice/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/jimoty-notice/list",
    style: {
      navigationBarTitleText: "列表"
    }
  }
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.137.1",\n        "192.168.88.1",\n        "192.168.225.1",\n        "10.201.85.186"\n    ],\n    "debugPort": 9001,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX.3.8.7.20230703/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"jimotyproject","spaceId":"mp-67be408c-9398-4e3f-bf46-1df6dcf05919","clientSecret":"ZCw/jZ56CpbiFSQ9JMBgHQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__EFAF570";
} catch (e2) {
