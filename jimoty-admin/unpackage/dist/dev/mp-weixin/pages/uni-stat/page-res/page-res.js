...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    o: common_vendor.sr("version-select", "29978b59-6"),
      ...
      return {
        a: common_vendor.f($data.fieldsMap, (mapper, index, i1) => {
          return common_vendor.e({
            ...
            d: "29978b59-13-" + i0 + "-" + i1 + "," + ("29978b59-12-" + i0 + "-" + i1),
            e: common_vendor.p({
              type: "compose",
              color: "#2979ff",
              size: "25"
            ...
            f: mapper.field,
            g: "29978b59-12-" + i0 + "-" + i1 + "," + ("29978b59-11-" + i0)
          } : {
            h: common_vendor.t(item[mapper.field] !== void 0 ? item[mapper.field] : "-"),
            i: mapper.field,
            j: "29978b59-14-" + i0 + "-" + i1 + "," + ("29978b59-11-" + i0),
            k: common_vendor.p({
    ...
    z: common_vendor.sr("inputClose", "29978b59-17,29978b59-16"),
    ...
    D: common_vendor.sr("inputDialog", "29978b59-16"),
    E: common_vendor.p({
      type: "dialog",
      maskClick: true
    })
