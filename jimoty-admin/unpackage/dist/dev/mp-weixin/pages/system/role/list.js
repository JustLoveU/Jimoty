...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "5b87151f-4-" + i0 + "," + ("5b87151f-3-" + i0),
        b: "5b87151f-5-" + i0 + "," + ("5b87151f-3-" + i0),
        c: "5b87151f-6-" + i0 + "," + ("5b87151f-3-" + i0),
        d: "5b87151f-7-" + i0 + "," + ("5b87151f-3-" + i0),
        e: "5b87151f-8-" + i0 + "," + ("5b87151f-3-" + i0),
        f: "5b87151f-9-" + i0 + "," + ("5b87151f-3-" + i0),
        g: "5b87151f-3-" + i0 + "," + ("5b87151f-2-" + i0),
        h: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.role_id),
            b: "5b87151f-11-" + i0 + "-" + i1 + "," + ("5b87151f-10-" + i0 + "-" + i1),
            c: common_vendor.t(item.role_name),
            d: "5b87151f-12-" + i0 + "-" + i1 + "," + ("5b87151f-10-" + i0 + "-" + i1),
            e: common_vendor.t(item.permission),
            f: "5b87151f-13-" + i0 + "-" + i1 + "," + ("5b87151f-10-" + i0 + "-" + i1),
            g: common_vendor.t(item.comment),
            h: "5b87151f-14-" + i0 + "-" + i1 + "," + ("5b87151f-10-" + i0 + "-" + i1),
            i: "5b87151f-16-" + i0 + "-" + i1 + "," + ("5b87151f-15-" + i0 + "-" + i1),
            j: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            k: "5b87151f-15-" + i0 + "-" + i1 + "," + ("5b87151f-10-" + i0 + "-" + i1),
            ...
            n: "5b87151f-17-" + i0 + "-" + i1 + "," + ("5b87151f-10-" + i0 + "-" + i1),
            o: index,
            p: "5b87151f-10-" + i0 + "-" + i1 + "," + ("5b87151f-2-" + i0)
          };
        }),
        i: common_vendor.sr("table", "5b87151f-2-" + i0 + ",5b87151f-1"),
        j: "5b87151f-2-" + i0 + ",5b87151f-1",
        k: common_vendor.p({
          loading,
    ...
    M: common_vendor.sr("udb", "5b87151f-1"),
