...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "486b2034-4-" + i0 + "," + ("486b2034-3-" + i0),
        b: "486b2034-5-" + i0 + "," + ("486b2034-3-" + i0),
        c: "486b2034-6-" + i0 + "," + ("486b2034-3-" + i0),
        d: "486b2034-7-" + i0 + "," + ("486b2034-3-" + i0),
        e: "486b2034-8-" + i0 + "," + ("486b2034-3-" + i0),
        f: "486b2034-3-" + i0 + "," + ("486b2034-2-" + i0),
        g: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.permission_id),
            b: "486b2034-10-" + i0 + "-" + i1 + "," + ("486b2034-9-" + i0 + "-" + i1),
            c: common_vendor.t(item.permission_name),
            d: "486b2034-11-" + i0 + "-" + i1 + "," + ("486b2034-9-" + i0 + "-" + i1),
            e: common_vendor.t(item.comment),
            f: "486b2034-12-" + i0 + "-" + i1 + "," + ("486b2034-9-" + i0 + "-" + i1),
            g: "486b2034-14-" + i0 + "-" + i1 + "," + ("486b2034-13-" + i0 + "-" + i1),
            h: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            i: "486b2034-13-" + i0 + "-" + i1 + "," + ("486b2034-9-" + i0 + "-" + i1),
            ...
            l: "486b2034-15-" + i0 + "-" + i1 + "," + ("486b2034-9-" + i0 + "-" + i1),
            m: index,
            n: "486b2034-9-" + i0 + "-" + i1 + "," + ("486b2034-2-" + i0)
          };
        }),
        h: common_vendor.sr("table", "486b2034-2-" + i0 + ",486b2034-1"),
        i: "486b2034-2-" + i0 + ",486b2034-1",
        j: common_vendor.p({
          loading,
    ...
    K: common_vendor.sr("udb", "486b2034-1"),
