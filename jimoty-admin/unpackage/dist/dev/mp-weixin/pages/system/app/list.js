...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "1d0a46f4-4-" + i0 + "," + ("1d0a46f4-3-" + i0),
        b: "1d0a46f4-5-" + i0 + "," + ("1d0a46f4-3-" + i0),
        c: "1d0a46f4-6-" + i0 + "," + ("1d0a46f4-3-" + i0),
        d: "1d0a46f4-7-" + i0 + "," + ("1d0a46f4-3-" + i0),
        e: "1d0a46f4-8-" + i0 + "," + ("1d0a46f4-3-" + i0),
        f: "1d0a46f4-3-" + i0 + "," + ("1d0a46f4-2-" + i0),
        g: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "1d0a46f4-10-" + i0 + "-" + i1 + "," + ("1d0a46f4-9-" + i0 + "-" + i1),
            c: common_vendor.t(item.name),
            d: "1d0a46f4-11-" + i0 + "-" + i1 + "," + ("1d0a46f4-9-" + i0 + "-" + i1),
            e: common_vendor.t(item.description),
            f: "1d0a46f4-12-" + i0 + "-" + i1 + "," + ("1d0a46f4-9-" + i0 + "-" + i1),
            g: "1d0a46f4-14-" + i0 + "-" + i1 + "," + ("1d0a46f4-13-" + i0 + "-" + i1),
            h: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            i: "1d0a46f4-13-" + i0 + "-" + i1 + "," + ("1d0a46f4-9-" + i0 + "-" + i1),
            j: common_vendor.o(($event) => $options.publish(item._id), index),
            k: common_vendor.o(($event) => $options.navigateTo("/uni_modules/uni-upgrade-center/pages/version/list?appid=" + item.appid, false), index),
            l: common_vendor.o(($event) => $options.navigateTo("./add?id=" + item.appid, false), index),
            m: common_vendor.o(($event) => $options.confirmDelete(item._id), index),
            n: "1d0a46f4-15-" + i0 + "-" + i1 + "," + ("1d0a46f4-9-" + i0 + "-" + i1),
            o: index,
            p: "1d0a46f4-9-" + i0 + "-" + i1 + "," + ("1d0a46f4-2-" + i0),
            q: common_vendor.p({
              disabled: item.appid === _ctx.appid
            })
          };
        }),
        h: common_vendor.sr("table", "1d0a46f4-2-" + i0 + ",1d0a46f4-1"),
        i: "1d0a46f4-2-" + i0 + ",1d0a46f4-1",
        j: common_vendor.p({
    ...
    E: common_vendor.t(_ctx.$t("common.button.publish")),
    F: common_vendor.t(_ctx.$t("common.button.version")),
    ...
    L: common_vendor.o($options.pageSizeChange),
    M: common_vendor.sr("udb", "1d0a46f4-1"),
