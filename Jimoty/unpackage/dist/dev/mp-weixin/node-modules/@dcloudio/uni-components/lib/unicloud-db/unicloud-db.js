...
const _sfc_main = {
  name: "UniClouddb",
  setup(props) {
    const dataListRef = props.ssrKey ? props.getone ? common_vendor.shallowSsrRef(void 0, props.ssrKey) : common_vendor.ssrRef([], props.ssrKey) : props.getone ? common_vendor.shallowSsrRef(void 0, "Sg59sR+eEiqC5LqJiNbWKA==") : common_vendor.ssrRef([], "pWWP4IFyA7lh2eLb9FRupA==");
