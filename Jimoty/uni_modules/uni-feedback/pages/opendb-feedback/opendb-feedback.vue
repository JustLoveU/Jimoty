<template>
	<view class="uni-container">
		...
		<uni-forms ref="form" :value="formData" validate-trigger="submit" err-show-type="toast">
			<uni-forms-item name="content" label="留言" required>
			...
			<uni-forms-item name="imgs" label="图片列表">
				<uni-file-picker ref="files" file-mediatype="image" :limit="6" return-type="array"
					v-model="formData.imgs" :auto-upload="false">
				</uni-file-picker>
			</uni-forms-item>
